...
for model_name in ['exact','aggregate','mean_field','no_mixing','sampling']:
    for method in ['projected_gradient','extra_gradient','best_response']:
        cfg = replace(case.dynamics_config, method=method, step_size=0.02, tolerance=0.1, stable_window=4, max_steps=120, cycle_tolerance=0.12, cycle_window=30, br_inner_steps=8, br_restarts=2)
